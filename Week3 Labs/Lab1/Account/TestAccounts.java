...
public class TestAccounts
{
    ...
    //Check balance
     ...
     //InterestAccount
     InterestAccount ia=new InterestAccount(10000);
     System.out.println("Iinterest Account ia object's data after creation");
     System.out.println(ia.toString());
     System.out.println();
     
     //add interest
     System.out.println("account after interest");
